...
- ~~`data/rankings.json` empty — Rankings component not implemented.~~ — **Implemented Sprint 39.** Pipeline, schema, all 3 UI surfaces, and Awards manual research (260/286 players, all 11 in-scope teams, confirmed complete on a second audit pass) are done. Transfermarkt/EA raw values still pending — see Sprint 39 retrospective in `docs/ROADMAP.md`.
